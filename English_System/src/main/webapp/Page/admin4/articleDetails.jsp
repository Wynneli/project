				...
				<form class="form-horizontal">
					<div class="form-group" id="chineseinfo">
						...
						<div class="col-md-10 col-sm-7">
							<textarea class="form-control" id="chinese" rows="7">${article.articleEnglish}</textarea>
						</div>
					</div>
					<div class="form-group" id="englishinfo">
						<label for="exampleInputPassword4" class="col-sm-2 ">英文</label>
						<div class="col-md-10 col-sm-7">
							<textarea class="form-control" id="english" rows="7">${article.articleChinese}</textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-7">
							<input type="text" class="form-control" disabled="disabled"
								id="exampleInputPassword4" value="${article.articleTime}">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-7">
							<input type="text" class="form-control" disabled="disabled"
								id="exampleInputPassword4" value="${article.articleScan}">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-7">
							<input type="text" class="form-control" disabled="disabled"
								id="exampleInputPassword4" value="${article.articleLike}">
						</div>
					</div>
					<br />
					<div class="row">
						...
						<div class="col-md-5">
							<button onclick="edit(${article.articleId})" type="button"
