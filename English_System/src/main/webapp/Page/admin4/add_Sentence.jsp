				...
				<form class="form-horizontal">
					<div class="form-group" id="chineseinfo">
						...
						<div class="col-md-10 col-sm-7">
							<textarea class="form-control" id="chinese" rows="5">${article.articleChinese}</textarea>
						</div>
					</div>
					<div class="form-group" id="englishinfo">
						<label for="exampleInputPassword4" class="col-sm-2 ">英文句子</label>
						<div class="col-md-10 col-sm-7">
							<textarea class="form-control" id="english" rows="5"></textarea>
						</div>
					</div>
