...
<script type="text/javascript" src="<%=basePath%>JS/admin4/add_test.js"></script>
			...
			<div class="row">
				<div class="col-md-2">
					<select class="form-control" id="first" >
						...
						<option>cet6_2015_6_2</option>
						<option>cet6_2016_6_2</option>
					</select>
				</div>
			</div>
			<br/>
						...
						<div class="panel-body ">
							<form class="form-horizontal">
								<c:if test="${not empty Part2}">
									<c:forEach items="${Part2}" varStatus="count" var="list">
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-10">
												<div class="form-group">
													...
													<div class="col-sm-10 col-md-7">
														<input type="text" class="form-control"
															name="cet4PartcQuestion${count.count}"> <span
