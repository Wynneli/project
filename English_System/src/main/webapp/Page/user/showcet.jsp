...
<body>
	...
	<div class="row setting">
		<div class="container">
			...
			<span class="span">${countcet4}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已学习：    ${cet4}  个词汇&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
				href="<%=basePath%>cet4/loading_cet4_word?cetid=cet4" target="_blank">继续学习词汇</a><br /> <br />
			<div class="progress">
			...
			<span class="span"> ${countcet6}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已学习：    ${cet6}  个词汇&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
				href="<%=basePath%>cet4/loading_cet4_word?cetid=cet6" target="_blank">继续学习词汇</a><br /> <br />
			<div class="progress">
				<div class="progress-bar" role="progressbar" aria-valuenow="40"
